...
def semantic_similarity(combined_sent, curr_sentence, tot_count):
...
if __name__ == "__main__":
    ...
    for each in brown.words():
        tot_count+=1
    dict1 = semantic_similarity(combined_sentence, final_sentence1, tot_count)
    dict2 = semantic_similarity(combined_sentence, final_sentence2, tot_count)
